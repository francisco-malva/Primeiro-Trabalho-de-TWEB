...
class SaleCalculator {
    ...
    static #brandModels = {
        "mercedes": [new Option("SUV", "suv"), new Option("SEDAN", "sedan"),
        new Option("CROSSOVER", "crossover"), new Option("PICAPE", "picape"),
        new Option("CUPÊ", "cupe")],
        "volvo": [new Option("C40", "c40"), new Option("EX90", "ex90"),
        new Option("V60", "v60"), new Option("V90", "v90")],
        "saab": [new Option("92 LINE", "95line"), new Option("EV-1", "ev-1"),
        new Option("VIKING", "viking"), new Option("9000 CABRIOLET", "9000cabriolet")],
        "audi": [new Option("A3 SEDAN", "a3 sedan"), new Option("A4 WAGON", "a4 wagon"),
        new Option("A5 COUPE", "a5 coupe"), new Option("A5 SPORTBACK", "a5 sportback"),
        new Option("Q3 SUV", "q3 suv"), new Option("Q4 SUV SPORTBACK", "q4 suv sportback")],
        "bmw": [new Option("X3", "x3"), new Option("X5", "x5"),
        new Option("X6", "x6"), new Option("iX3", "ix3"),
        new Option("iX M60", "ix m60"), new Option("iX1", "ix1")],
        "wv": [new Option("GOLF 4 TDi", "x3"), new Option("GOLF 5 TDi", "x5"),
